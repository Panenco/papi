 ...
 */
export type DecoratorSchema = SchemaObject | ((source: SchemaObject, options: IOptions) => SchemaObject);
 ...
 */
export function getMetadataSchema(target: object | Function, key: string): DecoratorSchema {
 ...
 */
function setMetadataSchema(value: DecoratorSchema, target: object | Function, key: string) {
