...
describe('defaultConverters', () => {
  ...
  before(() => {
    ...
    class User5 {
      ...
      @validator.IsIn([1, 2])
      isInNumber: number
      @validator.IsIn([Post5, Comment5])
      isInClass: Post5 | Comment5
      ...
      @validator.IsEnum(PostType5) isEnum: PostType5
  ...
  it('generates OpenAPI schemas from class-validator metadata', () => {
    expect(schemas.User5).eql({
      ...
      properties: {
        ...
        isEnumWithValue: { type: 'string', enum: ['anonymous', 'User5'] },
      ...
      required: schemas.User5.required,
      type: 'object',
    })
  })
})
